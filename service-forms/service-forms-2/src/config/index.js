...
const configDefault = {
  ...
  cognito: {
    ...
    poolId: 'us-east-1:8379b755-640e-4977-92b1-510bf6ba7cb0',
  },
  ...
  lex: {
    ...
    initialText: 'Hi there ! You can ask me for help in case you are stuck. ' +
    'Just type "Form Help" or click on the mic and say it.',

    // instructions spoken when mic is clicked
    initialSpeechInstruction: 'Say "Form Help" to get started',
